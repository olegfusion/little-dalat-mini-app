...
export const INITIAL_MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'cc-3', category: 'coffee_cocoa', vietnamese: 'Cà phê kem', english: 'Cream Coffee', russian: 'Кофе с кремом', price: 40000, variants: { vn: ['Muối', 'Trứng', 'Tiramisu'], en: ['Salted', 'Egg', 'Tiramisu'], ru: ['Соленый', 'Яичный', 'Тирамису'] } },
  ...
  { id: 'cc-6', category: 'coffee_cocoa', vietnamese: 'Sữa tươi cà phê sương sáo kem', english: 'Grass Jelly Cream Coffee', russian: 'Кофе с желе и кремом', price: 40000, variants: { vn: ['Muối', 'Trứng', 'Tiramisu'], en: ['Salted', 'Egg', 'Tiramisu'], ru: ['Соленый', 'Яичный', 'Тирамису'] } },
  ...
  { id: 'cc-8', category: 'coffee_cocoa', vietnamese: 'Ca cao kem', english: 'Cocoa Cream', russian: 'Какао с кремом', price: 40000, variants: { vn: ['Muối', 'Trứng', 'Tiramisu'], en: ['Salted', 'Egg', 'Tiramisu'], ru: ['Соленый', 'Яичный', 'Тирамису'] } },
  { id: 'cc-9', category: 'coffee_cocoa', vietnamese: 'Bạc xỉu', english: 'Bạc Xỉu (White Coffee)', russian: 'Бак Сиу (молочный кофе)', price: 35000, variants: { vn: ['Đá', 'Nóng'], en: ['Iced', 'Hot'], ru: ['Холодный', 'Горячий'] } },
  ...
  { id: 'bs-5', category: 'best_sellers', vietnamese: 'Cà phê kem', english: 'Cream Coffee', russian: 'Кофе с кремом', price: 40000, variants: { vn: ['Muối', 'Tiramisu'], en: ['Salted', 'Tiramisu'], ru: ['Соленый', 'Тирамису'] } },
  // SPECIAL FLOWER TEA
  ...
  { id: 'od-2', category: 'other_drinks', vietnamese: 'Sữa chua', english: 'Yogurt', russian: 'Йогурт', price: 35000, variants: { vn: ['Việt quất', 'Xoài', 'Dâu tây'], en: ['Blueberry', 'Mango', 'Strawberry'], ru: ['Черника', 'Манго', 'Клубника'] } },
  ...
  // DESSERTS & SNACKS
  { id: 'ds-1', category: 'desserts_snacks', vietnamese: 'Bánh Mousse', english: 'Mousse Cake', russian: 'Муссовый торт', price: 35000, variants: { vn: ['Tiramisu', 'Passion', 'Red Velvet'], en: ['Tiramisu', 'Passion Fruit', 'Red Velvet'], ru: ['Тирамису', 'Маракуйя', 'Красный бархат'] } },
  ...
  { id: 'ds-4', category: 'desserts_snacks', vietnamese: 'Bánh que chấm kem', english: 'Cream Biscuit Sticks', russian: 'Бисквитные палочки с кремом', price: 25000, variants: { vn: ['Muối', 'Trứng', 'Tiramisu'], en: ['Salted', 'Egg', 'Tiramisu'], ru: ['Соленый', 'Яичный', 'Тирамису'] } },
